...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        try {
            ...
            e.printStackTrace()
            Toast.makeText(this, "خطأ بالواجهة: ${e.localizedMessage}", Toast.LENGTH_LONG).show()
        }
    }
    ...
    private fun requestPermissionsSafely() {
        try {
            ...
            if (missing.isNotEmpty()) {
                ...
                Toast.makeText(this, "جميع الصلاحيات ممنوحة بالفعل!", Toast.LENGTH_SHORT).show()
            }
        } catch (e: Exception) {
            e.printStackTrace()
        }
    ...
    private fun showAddTemplateDialog() {
        ...
        try {
            ...
            e.printStackTrace()
            Toast.makeText(this, "خطأ في إنشاء النافذة: ${e.localizedMessage}", Toast.LENGTH_LONG).show()
        }
    }
